    ...
    <div class="container my-5">
        <div class="card shadow-sm">
            <div
                ...
                <h2 class="mb-0"><i class="fas fa-search me-2"></i> Risultati ricerca per: "{{ $query }}"</h2>
                <a href="{{ route('points-of-interest.index') }}" class="btn btn-light">
            ...
            <div class="card-body">
                @if ($pointsOfInterest->isEmpty())
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>Nessun risultato trovato per "{{ $query }}"
                    </div>
                @else
                                    ...
                                    <div class="card h-100 shadow">
                                        ...
                                        <div class="card-body text-center d-flex gap-3 justify-content-center"
                                            ...
                                            <a href="{{ route('points-of-interest.edit', $poi->id) }}"
                                                class="card-link btn btn-warning m-0">
